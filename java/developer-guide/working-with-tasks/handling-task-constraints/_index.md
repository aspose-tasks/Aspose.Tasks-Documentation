...
The ConstraintDate and ConstraintType properties are exposed by the [Task](https://reference.aspose.com/tasks/java/com.aspose.tasks/Task) class to handle constraints:
