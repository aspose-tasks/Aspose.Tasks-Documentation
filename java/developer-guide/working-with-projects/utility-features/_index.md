...
The [Project](http://www.aspose.com/api/java/tasks/com.aspose.tasks/classes/Project) class provides the [getCriticalPath()](http://www.aspose.com/api/java/tasks/com.aspose.tasks/classes/project/methods/getCriticalPath%28%29/) method which is used to get the list of tasks that part of the critical path. 
