...
The LogText property exposed by the [TasksReadingException](https://reference.aspose.com/tasks/java/com.aspose.tasks/tasksreadingexception) class is used to deal with such cases. You can use this property to identify the problematic section of the project, for example, a problematic task, resource, resource assignment etc.
