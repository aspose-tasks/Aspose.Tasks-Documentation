...
## **Assignment Budget**
The [ResourceAssignment ](https://apireference.aspose.com/cpp/tasks/class/aspose.tasks.resource_assignment/)class exposes a number of properties for working with an assignment's budget:
