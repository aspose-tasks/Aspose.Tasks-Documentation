...
type: docs
weight: 95
url: /cpp/aspose-tasks-for-cpp-21-6-release-notes/
---

{{% alert color="primary" %}} 

This page contains release notes information for [Aspose.Tasks for C++ 21.6](https://downloads.aspose.com/tasks/cpp/new-releases/aspose.tasks-for-c---21.6/).
