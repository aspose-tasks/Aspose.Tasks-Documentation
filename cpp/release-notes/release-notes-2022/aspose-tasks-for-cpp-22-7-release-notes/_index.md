...
type: docs
weight: 94
url: /cpp/aspose-tasks-for-cpp-22-7-release-notes/
---

{{% alert color="primary" %}} 

This page contains release notes information for [Aspose.Tasks for C++ 22.7](https://downloads.aspose.com/tasks/cpp/new-releases/aspose.tasks-for-c---22.7/).
