...
- Have a look through the [forums](https://forum.aspose.com/c/tasks), this documentation Wiki and the [API Reference](/pages/createpage.action?spaceKey=taskscpp&title=Aspose.Tasks+for+.NET+API+Reference&linkCreation=true&fromPageId=95322630) before reporting an issue. Your question may already have an answer.
...
|[Aspose.Tasks for C++ product documentation](http://docs.aspose.com/display/taskscpp/Home)|Full online documentation that includes this documentation as well as Aspose.Tasks API Reference.|
