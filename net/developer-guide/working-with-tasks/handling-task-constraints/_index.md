...
The [ConstraintDate](https://reference.aspose.com/tasks/net/aspose.tasks/tsk/fields/constraintdate) and [ConstraintType](https://reference.aspose.com/tasks/net/aspose.tasks/tsk/fields/constrainttype) properties are exposed by the static class [Tsk](https://reference.aspose.com/tasks/net/aspose.tasks/tsk) class to handle constraints:
