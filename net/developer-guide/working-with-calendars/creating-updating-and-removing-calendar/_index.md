...
There are three ways of creating a calendar in Aspose.Tasks. The [Calendar](http://www.aspose.com/api/net/tasks/aspose.tasks/calendar) class exposes the following three constructors:
...
The Days collection exposed by the [Calendar](http://www.aspose.com/api/net/tasks/aspose.tasks/calendar) class is used to define the weekdays for a calendar. The Days collection represents an array list of [WeekDay](http://www.aspose.com/api/net/tasks/aspose.tasks/weekday) objets.

The CreateDefaultWorkingDay method exposed by the WeekDay class can further be implemented to define the default day timings, while the FromTime and ToTime properties exposed by the [WorkingTime](http://www.aspose.com/api/net/tasks/aspose.tasks/workingtime) class is used to define the specific timing for a day. FromTime and ToTime support the DateTime data type.
...
The list of all calendars can be retrieved as [CalendarCollection](http://www.aspose.com/api/net/tasks/aspose.tasks/calendarcollection) using the [Project](http://www.aspose.com/api/net/tasks/aspose.tasks/project) class. The CalendarCollection can then be used to Remove or Add a new calendar as shown in the following code sample.
...
The [Calendar](http://www.aspose.com/api/net/tasks/aspose.tasks/calendar) class exposes the following two static (shared in Visual Basic) overloaded methods for creating a standard calendar:
