...
The CurrencySymbol property exposed by the [Project](https://reference.aspose.com/tasks/net/aspose.tasks/project/) class is used to set or get the currency symbol. This property supports the string data type.
