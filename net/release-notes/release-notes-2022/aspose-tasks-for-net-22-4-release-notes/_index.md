...
type: docs
weight: 97
url: /net/aspose-tasks-for-net-22-4-release-notes/
---

{{% alert color="primary" %}} 

This page contains release notes information for [Aspose.Tasks for .Net 22.4](https://downloads.aspose.com/tasks/net/new-releases/aspose.tasks-for-.net-22.4/).
